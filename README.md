...
| Step 2 | Python / .NET / JavaScript SDK | Coming soon |
| Step 3 | Microsoft Agent Framework・LangChain・RAG | Coming soon |
| Step 4 | Microsoft Foundry (クラウド) との比較・フォールバック | Coming soon |
| Step 5 | Execution Provider 性能・モデル運用 | Coming soon |
...
- **オフライン動作**: カタログからのモデル取得時のみネット必要。**BYOM（自前で ONNX 化したモデル）であれば最初からネット不要**で持ち込み可能。キャッシュ場所は `foundry cache cd` で任意フォルダに切替可能
